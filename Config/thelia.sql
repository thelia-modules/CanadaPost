...
DROP TABLE IF EXISTS `canada_post_service`;

CREATE TABLE `canada_post_service`
(
    `id` INTEGER NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `canada_post_service_i18n`;

CREATE TABLE `canada_post_service_i18n`
(
    `id` INTEGER NOT NULL,
